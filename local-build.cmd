...
cmake.exe -G"MinGW Makefiles" -DARDUINOJSON_ROOT="D:/Code Projects/cpp-libraries/arduinojson-v6.19.4-x86_64-posix-seh-rev0-8.1.0" -DCMAKE_BUILD_TYPE=Debug -B./build &&^
cd build &&^
cmake --build . &&^
